...
[![Go Report Card](https://goreportcard.com/badge/github.com/EternizedLab/grpcui)](https://goreportcard.com/report/github.com/EternizedLab/grpcui)
...
1. `github.com/EternizedLab/grpcui`: This package contains the building blocks for embedding a
...
2. `github.com/EternizedLab/grpcui/standalone`: This package goes a step further and supplies
...
```shell
go install github.com/EternizedLab/grpcui/cmd/grpcui@latest
```
